...
def test_parse_given_missing_required_column_raises_value_error():
    # Given
    parser = CSVParser(
        "./employee_salary_report/tests/test_csv_reports/test_missing_column.csv"
    )
...
def test_parse_given_invalid_numeric_value_raises_value_error():
    # Given
    parser = CSVParser(
        "./employee_salary_report/tests/test_csv_reports/test_invalid_data.csv"
    )
...
def test_parse_given_different_column_order_returns_correct_data():
    # Given:
    parser = CSVParser(
        "./employee_salary_report/tests/test_csv_reports/test_reordered.csv"
    )
...
def test_parse_given_values_with_spaces_trims_correctly():
    # Given
    parser = CSVParser(
        "./employee_salary_report/tests/test_csv_reports/test_spaces.csv"
    )
