...
def test_generate_report_with_single_department():
    ...
    employees = [
        Employee(id=1, email="alice@example.com", name="Alice", department="Marketing", hours_worked=160, hourly_rate=50),
        Employee(id=2, email="bob@example.com", name="Bob", department="Marketing", hours_worked=150, hourly_rate=40),
    ]
...
def test_generate_report_with_zero_values():
    # Given
    employees = [
        Employee(id=1, email="alice@example.com", name="Alice", department="Marketing", hours_worked=0, hourly_rate=50),
        Employee(id=2, email="bob@example.com", name="Bob", department="Design", hours_worked=150, hourly_rate=0),
    ]
